...
export const metadata: Metadata = {
  title: "Menu | Le Dee Thai Cuisine",
  description:
    "Menu for Le Dee Thai Cuisine in Chino Hills, CA — best sellers, appetizers, Le DEE Signature dishes, and soup.",
};
  ...
  return (
    <div>
      ...
      <div className="page-header">
        <span className="eyebrow">Le DEE Thai Cuisine</span>
